...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Retrieve the laboratory ID to be rejected from the POST request
    $laboratory = $_POST['id'];

    // Update the laboratory status to 'rejected'
    $sql = "UPDATE laboratory SET requestStatus = 'Rejected' WHERE id = ?";
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            $response = array('success' => true, 'message' => 'laboratory rejected.');
