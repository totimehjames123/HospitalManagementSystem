        ...
        <div class="bg-white" style="min-height: 80%; max-width: 90%; border-radius: 20px">
                    ...
                    <div class="bg-white " style="height: 100%; width: 100%">
                        ...
                        <div style="width: 90%">
                            <ul class="" style="width: 100%; height:60vh;">
                                <li class="mb-1 mt-2" style="list-style: none;"><a href="admin-module.php" class="text-dark pt-2 pb-2 pl-3 btn-block bg-light" style="border-radius: 6px; text-decoration: none;" ><span class="fa fa-home pr-2" style="color: purple;"></span>Dashboard</a></li>
                                <li class="mb-1 mt-2" style="list-style: none;"><a href="admin-manage.php" class="text-white pt-2 pb-2 pl-3 btn-block bg-primary" style="border-radius: 6px; text-decoration: none;"><span class="fa fa-calendar pr-2"></span>Manage</a></li>
            ...
            <div class="mainContainer col-md-9 overflow-hidden" style="height: 73vh; background: none;">
                ...
                <div class="overflow-auto p-3" style="height: 100%; ">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex w-100 justify-content-between p-1">
                                <h4 class="text-left">Manage Patients & Workers</h4>
                    ...
                    <div class="row pt-2">
                                    ...
                                    <div class="overflow-auto" style="height: 100%;">
                                        ...
                                        <form id="myForm" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nationalID" name="nationalID" placeholder="Enter National ID number">
                                            </div>
                                            <div class="form-group">
                                                <label for="mobileNumber">Mobile Number</label>
                                                <input type="tel" class="form-control" id="mobileNumber" name="mobileNumber" placeholder="Enter patient's mobile number">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="patientEmail" name="patientEmail" placeholder="Enter patient's email">
                                            </div>
                                            <button type="submit" class="btn btn-warning">Add as patient</button>
                                        </form>
                                    </div>
                        ...
                        <div class="col-md-4" style="height: 60vh; border-radius: 15px;">
                            <div class="text-bark bg-white  p-4 shadow-lg" style="height: 60vh; border-radius: 15px;">
                                ...
                                <div id="allUsers" class="overflow-auto rounded p-3" style="height: 45vh; width: 100%; padding-top: 0;">
                    ...
                    <!-- Manage Patient -->
                    <div>
                        <h5 class="mt-4 mb-1">Manage All Patients</h5>
                     </div>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr class="text-nowrap bg-success text-white" >
                                        ...
                                        <th class="text-nowrap">Patient's Mobile Number</th>
                                        <th class="text-nowrap">Profile Picture</th>
                                        <th class="text-nowrap">Edit</th>
                                        <th class="text-nowrap">Delete</th>                                      
                                    </tr>
                                </thead>
                                <tbody id="allPatients" class="">
                    ...
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mt-4 mb-1">Manage All Employees</h5>
                        <div class="mt-3 mr-2">
                            <span>Filter By: </span>
                            <input type="text" placeholder="Job Type" id="jobTitleFilter" name="jobTitleFilter" list="jobTitle" class="pl-2 no-outline border-0 bg-warning p-2" style="width: 110px; border-radius: 20px;">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr class="text-nowrap bg-success text-white" >
                                        ...
                                        <th class="text-nowrap">Employee's Profile Picture</th>
                                        <th class="text-nowrap">Emploee's ID</th>
                                        <th class="text-nowrap">Employee's Name</th>
                                        <th class="text-nowrap">Employee's Student ID</th>
                                        <th class="text-nowrap">Employee 's Email</th>
                                        <th class="text-nowrap">Employee's Country</th>
                                        <th class="text-nowrap">Emloyee's Home Address</th>
                                        <th class="text-nowrap">Employee's Gender</th>                                      
                                        <th class="text-nowrap">Employee's Job Title</th>                                      
                                        <th class="text-nowrap">Employee's Work Status</th>                                      
                                        <th class="text-nowrap">Employee's Tertiary Completed</th>                                      
                                        <th class="text-nowrap">Employee's National ID</th>                                      
                                        <th class="text-nowrap">Employee's Phone Number</th> 
