...
function fetchAppointments(searchTerm = "") {
  $.ajax({
    url: "backend-all-appointments.php",
    type: "GET",
    dataType: "json",
    success: function (data) {
      var html = "";
        ...
        if (
          ...
          html += `
                                      <tr class="text-nowrap">
                                          ...
                                          <td class="text-nowrap"><button data-id="${appointment.id}" data-patientname="${appointment.patientName}" ${appointment.appointmentStatus == "Canceled" ? "disabled='disabled'" : ""} class="cancel-appointment btn btn-warning btn-sm">Cancel</button></td>
                                      </tr>
                              `;
...
$(document).ready(function () {
  ...
  $("#myForm").submit(function (e) {
    ...
    $.ajax({
      url: "backend-doctor-create-appointment.php", // Replace with the actual URL to your server-side script
      ...
      success: function (response) {
        ...
        $("#result").html("Appointment scheduled successfully!");
