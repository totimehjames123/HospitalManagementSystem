                    ...
                    <div class="bg-white " style="height: 100%; width: 100%">
                        ...
                        <div style="width: 90%">
                            <ul class="" style="width: 100%; height:60vh;">
                                ...
                                <li class="mb-1 mt-2" style="list-style: none;"><a href="nurse-wards.php" class="text-dark pt-2 pb-2 pl-3 btn-block bg-light" style="border-radius: 6px; text-decoration: none;"><span class="fa fa-calendar pr-2" style="color: pink;"></span>Wards & Beds</a></li>
                                <li class="mb-1 mt-2" style="list-style: none;"><a href="nurse-medication.php" class="text-dark pt-2 pb-2 pl-3 btn-block bg-light" style="border-radius: 6px; text-decoration: none;"><span class="fa fa-calendar pr-2 text-success" ></span>Medications</a></li>
