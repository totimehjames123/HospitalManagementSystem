...
<head>
    ...
    <link rel="stylesheet" href="style.css">
    <title>Admin - medicines & Medicines</title>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    <script src="pharmacist-record.js"></script>
                ...
                <div class="overflow-auto p-3" style="height: 100%; ">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex w-100 justify-content-between p-1">
                                <h4 class="text-left">Manage Medicines</h4>
                    ...
                    <div class="row pt-2">
                                    ...
                                    <div class="overflow-auto" style="height: 100%;">
                                        ...
                                        <form id="myForm" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" min="0" class="form-control" id="unitPrice" name="unitPrice" placeholder="Enter Quantity" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="expiryDate">Expiry Date</label>
                                                <input type="date" class="form-control" id="expiryDate" name="expiryDate" placeholder="Enter Nurse in charge's name" required>
                                            </div>
                                            
                                            <div class="form-group d-none">
                                                <input type="text" value="<?php echo $_SESSION["employeeId"]; ?>" class="form-control" name="employeeId" required required>
                                            </div>
                        ...
                        <div class="col-md-4" style="height: 60vh; border-radius: 15px;">
                            <div title="Click on the edit button on any of the medicines below." class="text-bark bg-white  p-4 shadow-lg" style="height: 60vh; border-radius: 15px;">
                                <h5>Edit Medications</h5>
                                ...
                                <div class="overflow-auto rounded p-3" style="height: 45vh; width: 100%; padding-top: 0;">
                                    ...
                                    on any of the medicines below.</small>
                                    ...
                                    <div id="updateResult" class="mb-2"></div>
                                        <form id="updateForm" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label for="medicineName">Medicine Name</label>
                                                <input type="text" class="form-control" id="medicineNameUpdate" name="medicineName" placeholder="Enter medicine name" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="quantity">Quantity</label>
                                                <input type="number" min="0" class="form-control" id="quantityUpdate" name="quantity" placeholder="Enter Quantity" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="unitPrice">Unit Price</label>
                                                <input type="text" class="form-control" id="unitPriceUpdate" name="unitPrice" placeholder="Enter Unit Price" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="expiryDate">Expiry Date</label>
                                                <input type="date" class="form-control" id="expiryDateUpdate" name="expiryDate" required>
                                            </div>
                    ...
                    <!-- Manage Patient -->
                    <div>
                        <h5 class="mt-4 mb-1">Manage All medicines</h5>
                     </div>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr class="text-nowrap bg-success text-white" >
                                        ...
                                        <th class="text-nowrap">Available Medicines</th>
                                        <th class="text-nowrap">Purchased Medicines</th>
                                        <th class="text-nowrap">Unit Price</th>
                                        <th class="text-nowrap">Total Price</th>
                                        <th class="text-nowrap">Amount Purchased</th>
                                        <th class="text-nowrap">Amount Left</th>
                                        <th class="text-nowrap">Pharmacist Who Created</th>
