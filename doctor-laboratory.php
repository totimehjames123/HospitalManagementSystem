...
<head>
    ...
    <script src="doctor-laboratory.js"></script>
                            ...
                            <div class="p-4 shadow-lg" style="height: 60vh; border-radius: 15px;">
                                <div class="overflow-hidden" style="height: 100%;"> 
                                    <div class="overflow-auto" style="height: 100%;">
                                        <div class="alert alert-warning">Select a patient there 👉 to make a request for 🙂</div>
                                        ...
                                        <form id="myForm" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="serviceType">Laboratory Service Type</label>
                                                <select name="serviceType" id="serviceType" class="form-control">
                                                    ...
                                                    <option value="Bone Density Test (DEXA Scan)">Bone Density Test (DEXA Scan)</option>
                                                    ...
                                                    <option value="Cardiac Enzyme Test">Cardiac Enzyme Test</option>
                                                    <option value="Malaria Test">Malaria Test</option>
                                                </select>
                                            </div>
                                            
                                            <button type="submit" class="btn btn-warning">Send Laboratory Request</button>
                                        </form>
                                    </div>
