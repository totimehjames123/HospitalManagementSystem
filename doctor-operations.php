...
<head>
    ...
    <script src="doctor-operations.js"></script>
                            ...
                            <div class="p-4 shadow-lg" style="height: 60vh; border-radius: 15px;">
                                <div class="overflow-hidden" style="height: 100%;"> 
                                    <div class="overflow-auto" style="height: 100%;">
                                        <div class="alert alert-warning">Kindly scroll downwards 👇 if you want to add a report 🙂</div>
                                        ...
                                        <form id="myForm" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="startDateTime">Operation Starts At</label>
                                                <input type="datetime-local" class="form-control" id="startDateTime" name="startDateTime" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="notes">Notes about the operation</label>
                                                <textarea rows="10" class="form-control" id="notes" name="notes" placeholder="Write a short notes about the operation..." required></textarea>
                                            </div>
                                            
                                            <button type="submit" class="btn btn-warning">Send Operation Request</button>
                                        </form>
                                        <br>
                                        <form id="reportForm">
                                            <small>Do you want to 👇 ... ?</small>
                                            <div id="resultReport"></div>
                                            <h4 class="mt-4">Write Operation Report</h4>
                                            <div class="form-group">
                                                <label for="patientName1">Patient Name</label>
                                                <input type="text" class="form-control" id="patientName1" name="patientName" placeholder="Enter patient's name" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="nationalID1">National ID</label>
                                                <input type="text" class="form-control" id="nationalID1" name="nationalID" placeholder="Enter Patient's National ID number" required>
                                            </div>
                                            <input type="hidden" name="employeeId" value="<?php echo $_SESSION["employeeId"]?>">
                                            <div class="form-group">
                                                <label for="operationReport">Write your report below</label>
                                                <textarea rows="10" class="form-control" id="operationReport" name="operationReport" placeholder="Type report here..." required></textarea>
                                            </div>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr class="text-nowrap bg-success text-white" >
                                        ...
                                        <th class="text-nowrap">Operation Type</th>                                      
                                        <th class="text-nowrap">Request Status</th>                                      
                                        <th class="text-nowrap">Notes</th>                                      
                                        <th class="text-nowrap">Operation Starts On</th>                                      
                                        <th class="text-nowrap">Operation Created On</th>                                      
                                        <th class="text-nowrap">Cancel Request</th> 
