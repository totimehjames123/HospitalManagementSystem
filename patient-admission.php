                    ...
                    <div class="bg-white " style="height: 100%; width: 100%">
                        ...
                        <div style="width: 90%">
                            <ul class="" style="width: 100%; height:60vh;">
                                <li class="mb-1 mt-2" style="list-style: none;"><a href="patient-module.php" class="text-white pt-2 pb-2 pl-3 btn-block bg-primary" style="border-radius: 6px; text-decoration: none;" ><span class="fa fa-home pr-2"></span>Dashboard</a></li>
                                <li class="mb-1 mt-2" style="list-style: none;"><a href="patient-appointment.php" class="text-dark pt-2 pb-2 pl-3 btn-block bg-light" style="border-radius: 6px; text-decoration: none;"><span class="fa fa-calendar pr-2" style="color: purple;"></span>Appointment</a></li>
                                ...
                                <li class="mb-1 mt-2" style="list-style: none;"><a href="patient-admission.php" class="text-dark pt-2 pb-2 pl-3 btn-block bg-light" style="border-radius: 6px; text-decoration: none;"><span class="fa fa-calendar pr-2 text-warning" ></span>Admission</a></li>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex w-100 justify-content-between p-1">
                                <h4 class="text-left">Patient Admission List</h4>
                                    ...
                                    <div class="overflow-auto" style="height: 100%;">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="Symptoms" placeholder="Enter Symptoms of Patient">
                                            </div>

                                            <div class="form-group">
                                                <label for="serviceType">Operation Type</label>
                                                <select name="operationType" id="operationType" class="form-control">
                                                    ...
                                                    <option value="Lung Surgery">Lung Surgery</option>
                                                    <option value="Kidney Transplant">Kidney Transplant</option>
                                                    <option value="Liver Transplant">Liver Transplant</option>
                                                    <option value="Gastrointestinal Endoscopy">Gastrointestinal Endoscopy</option>
                                                    <option value="Orthopedic Fracture Repair">Orthopedic Fracture Repair</option>
                                            ...
                                            <button type="submit" class="btn btn-warning">Request Laboratory Services</button>
                                        </form>
                                    </div>
