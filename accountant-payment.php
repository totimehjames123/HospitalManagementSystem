...
<head>
    ...
    <script src="accountant-payment.js"></script>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex w-100 justify-content-between p-1">
                                <h4 class="text-left">Do Payments</h4>
                                    ...
                                    <div class="overflow-auto" style="height: 100%;">
                                        ...
                                        <form id="myForm" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"  class="form-control" id="id" name="id" placeholder="Click 'Pay' button of a record in table below" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="medicineName">Medicine Name</label>
                                                <input type="text"  class="form-control" id="medicineName" name="medicineName" placeholder="Click 'Pay' button of a record in table below" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="patientName">Patient Name</label>
                                                <input type="text" class="form-control" id="patientName" name="patientName" placeholder="Click 'Pay' button of a record in table below"  required>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="amountPaid">Amount Paid</label>
                                                <input type="text"  class="form-control" id="amountPaid" name="quantity" placeholder="Click 'Pay' button of a record in table below" required>
                                            </div>
                                            
                                            <div class="form-group d-none">
                                                <input type="text" value="<?php echo $_SESSION["employeeId"]; ?>" class="form-control" name="accountantId" required>
                                            </div>
