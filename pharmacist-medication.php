...
<head>
    ...
    <script src="pharmacist-medication.js"></script>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        select.append('<option value="'+ value.medicineName +'">');
                    });
                },
                error: function() {
                                    ...
                                    <div class="overflow-auto" style="height: 100%;">
                                        ...
                                        <form id="myForm" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" list="med" class="form-control" id="medicineName" name="medicineName" placeholder="Enter medicine Name" required>
                                                <datalist id="med">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr class="text-nowrap bg-success text-white" >
                                        <th class="text-nowrap">Pharmacy ID</th>
                                        ...
                                        <th class="text-nowrap">Accountant Id</th>                                      
